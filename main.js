...
const projects = [{
  ...
  tasks: [{
    id: 15,
    name: 'User registration API endpoint development',
    done: false
  }, {
    id: 16,
    name: 'Database setup for user information storage',
    done: false
  }, {
    id: 17,
    name: 'User authentication and authorization with access tokens',
    done: false
  }, {
    id: 18,
    name: 'Unit testing for API endpoint functionality',
    done: false
  }, {
    id: 19,
    name: 'User registration API endpoint development',
  ...
  tasks: [{
    ...
    id: 36,
    name: 'Implement responsive design for various screen sizes',
    done: false
  }, {
    id: 37,
    name: 'Implement form validation for user input',
    done: false
  }, {
    id: 38,
    name: 'Optimize performance by lazy loading images',
    done: false
  }, {
    id: 39,
    name: 'Implement responsive design for mobile devices',
  ...
  tasks: [{
    id: 45,
    name: 'Implement user authentication using Firebase Authentication',
    done: false
  }, {
    id: 46,
...
/* harmony default export */ const js_projects = (projects);
;// CONCATENATED MODULE: ./src/js/WidgetTasks.js
...
class WidgetTasks {
  ...
  showTasks(e) {
    ...
    const {
      tasks
    } = js_projects.find(project => project.id === +this.projectId);
    this.clearTasks();
  ...
  handleCheckboxChange(e) {
    ...
    const {
      tasks
    } = js_projects.find(obj => obj.id === +this.projectId);
...
;// CONCATENATED MODULE: ./src/js/WidgetStats.js
...
;// CONCATENATED MODULE: ./src/js/reduce.js
